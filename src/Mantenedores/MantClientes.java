...
//haciendo prueba nuevamente
    ...
    //Limpia todos los Label de error 
    ...
    //Llena el JTable con el listado de clientes
    ...
    //Llena el JTable de clientes al realizar las consultas
    ...
    //limpia los JTextField de la pantalla
    public void limpiar() {
        txt_consulta.setText("");
        txt_correo.setText("");
    ...
    //Valida si el formato email es correcto
    ...
    private void initComponents() {
        ...
        main.add(btn_consultar, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 120, 70, 80));
        ...
        main.add(lb_err5, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 520, -1, -1));
        ...
        lb_err7.setLabelFor(txt_direccion);
        lb_err7.setText("jLabel3");
        main.add(lb_err7, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 520, -1, -1));

        lb_err8.setFont(new java.awt.Font("Tahoma", 1, 13)); // NOI18N
        lb_err8.setForeground(new java.awt.Color(255, 0, 51));
        lb_err8.setLabelFor(txt_direccion);
        lb_err8.setText("jLabel3");
        main.add(lb_err8, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 520, -1, -1));
