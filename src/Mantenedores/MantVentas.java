...
public class MantVentas extends javax.swing.JFrame {
    ...
    public void llenarlst_consu(String consu) {
        ...
        try {
            sentencia = (Statement) conexion.createStatement();//permite ejecutar sentencias SQL
            ResultSet lista = sentencia.executeQuery("SELECT * FROM venta WHERE rut_cliente like '%" + consu + "%'or fecha_venta like '%" + consu + "%'"
            ...
            while (lista.next()) {
                ...
                rut = (lista.getString("rut_cliente"));
                dv = (lista.getString("dv_cliente"));
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                ...
                                .addComponent(dc_fecha, javax.swing.GroupLayout.DEFAULT_SIZE, 173, Short.MAX_VALUE)))
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(lb_err1, javax.swing.GroupLayout.Alignment.TRAILING)))
